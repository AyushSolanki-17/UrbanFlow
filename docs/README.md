...
**Status:** design documentation with runnable repository quality tooling. The repository currently has no application, deployment infrastructure, pipelines, trained models, or measured benchmarks. Components and interfaces below are targets, not deployed capabilities. [Contributor setup](../CONTRIBUTING.md) runs formatting/linting and installs Git hooks; application setup is still to be implemented.
